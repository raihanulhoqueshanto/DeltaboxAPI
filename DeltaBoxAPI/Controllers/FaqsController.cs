...
namespace DeltaboxAPI.Controllers
{
    ...
    public class FaqsController : ControllerBase
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetProductFaq(int? id, int? productId, string? keyword, string? isActive, string? getAll, int currentPage, int itemsPerPage)
        {
            try
            {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetProductReview(int? id, int? productId, string? keyword, string? isActive, string? getAll, int currentPage, int itemsPerPage)
        {
            try
            {
                var result = await _mediator.Send(new GetProductReview(id, productId, keyword, isActive, getAll, currentPage, itemsPerPage));
